...
module FiscalAuditor
  class ReceivableSnapshot
    DEFAULT_PATH = Rails.root.join("storage/private/fiscal_auditor/receivables.marshal.gz")
    FORMAT_VERSION = 2
    ...
    def rebuild
      payload = {
        ...
        signature: signature,
        records: source_paths.flat_map { |path| ReceivableWorkbook.new(path).records }
      }
